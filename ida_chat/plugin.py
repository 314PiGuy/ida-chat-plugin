...
from ida_chat.core import IDAChatCore, ChatCallback, test_provider_connection
...
from ida_chat.ui.elements import (
    ChatHistoryWidget,
    ChatInputWidget,
    CollapsibleSection,
    EventLogWidget,
...
class IDAChatForm(ida_kernwin.PluginForm):
    ...
    def _on_share(self):
        ...
        from pathlib import Path
        from ida_chat.core import export_transcript
