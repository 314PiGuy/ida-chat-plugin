...
# Import package module first (before ida_domain which may modify sys.path)
from ida_chat.core import IDAChatCore, ChatCallback
...
def run_transcript_command(args: list[str]) -> int:
    ...
    from ida_chat.core import export_transcript_to_dir
